...
### 7.1.1 这批素材还兼任「色板出处」(2026-09-17)

需方点名 `assets/cover/thumbnail_375.jpg` 作为**站点夜/昼底色的色系来源** ——
它是「深橄榄绿笔触 `#173400` 落在米白纸底 `#F0F0F0` 上」。站点的两套令牌就是它的取样与递进:

```text
夜底   #0E1E05  (笔触绿再深一档)      昼底   #C9DDD5  (浅海蓝绿,需方指定)
夜面   #16290B  → #1E3611             昼面   #F4EFE1 → #E7E0CC  (浅卡其,与海报纸同族)
夜字   #F2F5EC  (纸白)                昼字   #11302A  (深墨绿)
强调   #93A4FF  (夜,logo 靛蓝提亮版)  强调   #1B2C7A  (昼,同一支靛蓝深版)
```

强调色不在这张图里 —— 它取的是**图标 logo 的靛蓝 `#042366`**(绿底的互补色,也是「字体重点色」)。

取样命令与实测对比度表见 `docs/DESIGN-PLAN.md` §7.6。**这张图不上站**(它只是取样源,不上传线上)。
