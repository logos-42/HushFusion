...
| 前置条件 | ⚠️ **法律闸门**:本冻结**不等于可以上线**。任何收款相关条目的执行,都以阶段二的书面专业法律意见为前置(§八 / `DONATION-FUND-PLAN.md` §10.1);若结论是"不能公开募资",改走 §九 的**无钱路线** |
...
## 九 降级路线:不含钱的另一半(公开审计记录层)

一旦法域判断的结论是"不能面向境内公开募集加密资产",**不要整体作废这套设计** —— 把"钱"的那一段整段删掉,剩下的一半仍能落地,而且法律风险与反钓鱼风险同时归零。
...
| 7 | **目标受众法域** | 境内为主 → **放弃公开加密捐赠**,只保留 §九 公开审计记录层 | 境外受众为主 → 先取境外主体/税务/AML 意见,且不得假定"部署在境外"即合规 |
