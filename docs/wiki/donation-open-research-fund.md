...
## 当前路线(2026-09-22 需方确定)

| 维度 | 结论 |
|:--|:--|
| 资金路线 | **境外募资**(法域与主体未定 → 收款侧**冻结**) |
| 首页路线 | **公开记录** —— 区块 `#records`「公开记录 / Open Research Records」,取代捐赠入口 |
| 资金状态 | 冻结:不部署收款、不建立募资 Safe、不公开任何地址 |
| 唯一硬阻塞 | **没有独立第三方 GUARDIAN**(六条资格) |
| 本阶段只推进 | ① [公开记录层](../RECORDS-LAYER-PLAN.md) ② [境外法域与主体筛选](../FUNDING-JURISDICTION-SCREENING.md) ③ [GUARDIAN 候选机制](../GUARDIAN-DESIGN.md) |
| 暂不推进 | 收款合约 · 钱包连接 · Safe 建立 · 地址公开 · 主网部署 · 真实募资 |
...
| 2026-09-22 | **路线确定**:境外募资 + 首页公开记录(记录层从"降级方案"升为当前路线)+ 收款侧冻结;**GUARDIAN 是唯一硬阻塞**;新增 T-G1…T-G4 换人转移与威胁 **T1b(绕过 GUARDIAN)**;三份新设计文档 |
